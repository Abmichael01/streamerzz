    ...
    return (
        <motion.section
            ...
            <div className='max-w-7xl mx-auto px-4 flex flex-col items-center text-center'>
                <motion.div 
                variants={fadeInUp}
                className='mb-8 border-neutral-800 px-3 rounded-full text-x5'>
                ...
                className='mt-6 space-x-4'>
                    ...
                    <a href='#' className='inline-block border border-gray-500 hover:bg-neutral-400 text-white py-3 px-6 rounded-lg font-medium'>
                ...
                variants={fadeIn}
                className='mt-12'>
                    <img src={heroImage} alt="Streamer SaaS Interface" className='w-full h-auto rounded-2xl border border-neutral-800' />
                </motion.div>
            </div>
        </motion.section>
    )
